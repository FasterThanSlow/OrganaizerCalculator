...
public class RevealColorView extends ViewGroup {
    ...
    private com.nineoldandroids.view.ViewPropertyAnimator animator;
    ...
    public com.nineoldandroids.animation.Animator createCircularReveal(final int x, final int y, final int color) {
